(()=>{
  ...
  const start=()=>{
    ...
    if(page==='specials'){
      ...
      add('Looking at MAAX Saunas? I can help you compare the traditional, infrared and outdoor options — and match a separately priced heater where one is required.');
